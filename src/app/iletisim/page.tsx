  ...
  return (
    <main style={{ maxWidth: "800px", margin: "0 auto", padding: "3rem 1rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem" }}>
        ...
        {/* Sağ: İletişim Formu (API Entegreli ve State Kontrollü) */}
        <div style={{ backgroundColor: "#ffffff", padding: "1.5rem", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              <button 
                type="submit" 
                disabled={loading}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", backgroundColor: "#dc2626", color: "#ffffff", padding: "0.75rem", borderRadius: "8px", border: "none", fontWeight: 700, cursor: "pointer" }}
              >
